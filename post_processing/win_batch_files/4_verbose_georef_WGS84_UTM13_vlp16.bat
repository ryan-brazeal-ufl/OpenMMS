...
set output_file=verbose_pc.laz
...
if %counter1%==1 (
if %counter2%==1 (
python C:\OpenMMS\code\openmms_georeference_vlp16.py C:\OpenMMS\code\serf\geo\ C:\OpenMMS\sys_params\%boresight_file% %nav% %pcap% %output_file% %quick_processing% %verbose_output% %start_proc_time% %end_proc_time% %thin_factor% %display_plots% %geo_cs% %proj_cs% %cd% %use_vlp16_calibration%
)
)
